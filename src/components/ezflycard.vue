<template>
  <div style="position: relative;height: 100%;width:100%;margin-top: 150px" :style="{paddingLeft:paddingLeft+'px'}">
    <div style="position: absolute;left:50%;top:50%;transform: translate(-50%,-50%);"
      ...
      <div class="card" style="z-index: 13;"
           ...
           :class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}" @touchstart="touchStart"
           @touchmove="touchMove" @touchcancel="touchCancel" @touchend="touchCancel">
        <slot name="firstCard"></slot>
      </div>
      <div class="card" style="z-index: 12;"
           :style="{width:width2+'px',height:height2+'px',left:left2+'px',top:top2+'px','border-radius':borderRadius+'px',backgroundColor:cardBgColor}"
      ...
      <div class="card" style="z-index: 11;"
           :style="{width:width3+'px',height:height3+'px',left:left3+'px',top:top3+'px','border-radius':borderRadius+'px',backgroundColor:cardBgColor}"
           :class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}">
        <slot name="thirdCard"></slot>
      </div>
      <div class="card" style="z-index: 10;"
           :style="{width:width4+'px',height:height4+'px',left:left4+'px',top:top4+'px','border-radius':borderRadius+'px',backgroundColor:cardBgColor,opacity:opacity4}"
           :class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}">
      </div>
    </div>
  </div>
